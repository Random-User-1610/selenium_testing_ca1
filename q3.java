...
//		  Thread.sleep(4000);
//		  WebElement hp=driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[1]/div[1]/div/span[1]/div[1]/div[11]/div/div/div/div/div[2]/div[2]/div/a/span[1]/span[2]/span[2]"));
//		  String thp=hp.getText();
//		  System.out.println("High to low -> first product price"+thp);
		  
//		  driver.findElement(By.xpath("/html/body/div[1]/div[2]/span/div/h1/div/div[2]/div/div/form/span/span/span/span/span[2]")).click();
//		  Thread.sleep(1000);
//		  driver.findElement(By.xpath("//*[@id=\"s-result-sort-select_3\"]")).click();
//		  Thread.sleep(4000);
//		  WebElement az=driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[1]/div[1]/div/span[1]/div[1]/div[3]/div/div/div/div/div[2]/div[2]/div/span[2]/a/span"));
//		  Thread.sleep(1000);
//		  String taz=az.getText();
//		  System.out.println("Avg cutomer review -> first product "+taz);
//		  
//		  driver.findElement(By.xpath("/html/body/div[1]/div[2]/span/div/h1/div/div[2]/div/div/form/span/span/span/span/span[2]")).click();
//		  Thread.sleep(1000);
//		  driver.findElement(By.xpath("//*[@id=\"s-result-sort-select_4\"]")).click();
//		  Thread.sleep(4000);
//		  WebElement na =driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[1]/div[1]/div/span[1]/div[1]/div[3]/div/div/div/div/div[2]/div[3]/div"));
//		  String tna=na.getText();
//		  System.out.println("Newest arrival -> first product "+tna);
	  }
	  @AfterTest
